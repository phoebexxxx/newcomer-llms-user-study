...
st.set_page_config(page_title="First Session", layout="wide")
...
GROUPS = {
    "Group A": groups.system_prompt_scaffolding(),
    "Group B": groups.system_prompt_scaffolding(),
    "Group C": groups.system_prompt_baseline(),
    "Group D": groups.system_prompt_baseline(),
}
TASKS = {
    "Group A": groups.task_1(),
    "Group B": groups.task_2(),
    "Group C": groups.task_1(),
    "Group D": groups.task_2(),
}
STAGE_PROMPTS = {
...
INITIALS = {
    "Group A": groups.initials_scaffolding(),
    "Group B": groups.initials_scaffolding(),
    "Group C": groups.initials_baseline(),
    "Group D": groups.initials_baseline(),
}
...
if group == "Group A" or group =="Group B":
    ...
    with right_col:
        ...
        st.subheader(f"🤖 Chat with {NAMES[group]}, the AI assistant.")
        # st.write("WikiAnswer is an AI helper for you to edit Wikipedia. It's designed both to help you complete edits, and learn about important Wikipedia policies and editing skills along the way. You can ask WikiCoach questions, follow up on its answers, or explore ideas together. The more you talk with it, the more helpful it can be. If the assistant didn't respond, it is likely because it didn't receive your message. Simply send your question or request again. It may take a moment for the assistant to think.")
        # st.markdown(
        # "<p style='color: red; font-weight: bold;'>Note: WikiCoach may behave differently from other AI you've used before.</p>",
        # unsafe_allow_html=True
        # )
